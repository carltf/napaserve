  ...
  return (
    <div style={{ marginBottom: 48 }}>
      ...
      <Caption
        ...
        sources={[
          { label: "California Department of Finance E-1 Population Estimates, May 2024, May 2025 and May 2026 releases", url: "https://dof.ca.gov/forecasting/demographics/estimates/" },
        ]}
      />
    </div>
  );
  ...
  return (
    <div style={{ marginBottom: 48 }}>
      ...
      <Caption
        ...
        sources={[
          { label: "California Department of Finance E-1 and E-1H Population and Housing Estimates, 2010–2026", url: "https://dof.ca.gov/forecasting/demographics/estimates/" },
        ]}
      />
    </div>
  );
    ...
    <div style={{ background: T.bg, minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: isDraft ? "80px 20px 60px" : "60px 20px 60px" }}>
        ...
        <p style={{ ...P_STYLE, marginBottom: 18 }}>
          <strong>NAPA VALLEY, Calif.</strong> {"—"} The May 1 release from <a href="https://dof.ca.gov/forecasting/demographics/estimates/" target="_blank" rel="noopener noreferrer" style={LINK}>California{"’"}s Department of Finance</a> is the cleanest population data the state produces, and this year it tells a story Napa County has not heard since the COVID rebound. California declined. Napa County declined. And inside that decline, the geography of growth flipped.
        </p>
        ...
        <p style={P_STYLE}>
          A note on the data. The <a href="https://dof.ca.gov/forecasting/demographics/estimates/" target="_blank" rel="noopener noreferrer" style={LINK}>May 2025 E-1 release</a> benchmarked Napa County{"’"}s January 1, 2025 population at 136,124. The May 2026 release revises that figure upward to 136,620, then estimates the decline to 136,374. Department of Finance benchmarks every release back to the most recent census, which means the new vintage supersedes the old wherever they overlap. The comparisons in this piece use the revised series throughout.
        </p>
        ...
        <div style={{ borderTop: `2px solid ${T.border}`, paddingTop: 28, marginTop: 40 }}>
          ...
          <p style={{ fontFamily: font, fontSize: 14, color: T.muted, lineHeight: 1.7, fontStyle: "italic" }}>
            Each year{"’"}s percent change in Chart 1 is computed within its own release vintage; the unincorporated 2023-2024 figure is computed by subtraction from the county total since the May 2024 release coverage available did not separately report it. Chart 2 uses fiscal-year totals from the City of Calistoga Transient Occupancy Tax Report, April 2026 vintage; intermediate fiscal-year values between FY13-14 and FY25-26 anchors are pending the next published TOT detail and are flagged in the source code. Chart 3{"’"}s housing-to-income multipliers use 5-year ACS estimates for income and Zillow Home Value Index for typical home value as of May 2026; the BLS Quarterly Census of Employment and Wages provides the NAICS 72 hospitality-wage figure. Chart 4 uses the most recent revised E-1 and E-1H series from the May 2026 release wherever vintages overlap. Linked text throughout the body anchors directly to the document or data point being cited; the May 2026 E-1 release benchmarks every prior year against the most recent census, so revisions to 2024 and 2025 figures appear between chart series and inline-cited values.
          </p>
        </div>
        ...
        <div style={{ borderTop: `1px solid ${T.border}`, marginTop: 40, paddingTop: 24 }}>
          ...
          <ol style={{ fontFamily: font, fontSize: 14, color: T.ink, lineHeight: 1.75, paddingLeft: 20 }}>
            <li style={{ marginBottom: 8 }}>California Department of Finance, <a href="https://dof.ca.gov/forecasting/demographics/estimates/" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>E-1 Population Estimates, May 1, 2026</a>.</li>
            <li style={{ marginBottom: 8 }}>California Department of Finance, <a href="https://dof.ca.gov/forecasting/demographics/estimates/" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>E-1 Population Estimates, May 1, 2025</a>.</li>
