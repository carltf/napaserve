...
const SECTIONS = [
  ...
  { id: "watch", heading: "What to Watch", body: "The Hormuz closure is weeks old. The full transmission of the shock through supply chains, energy markets and visitor economies will take months to appear in local data. California diesel prices at the pump are the most immediate signal. Napa County lodging data will show visitor response within 60 to 90 days. Grape and bulk wine contract activity will reflect whether buyers are pulling back or accelerating purchases ahead of further cost increases.\n\nThe planners, policymakers, community members and civic leaders who shape Napa Valley\u2019s economic future are making decisions now that will interact with this shock over the next 12 to 24 months. The data above is a starting point for understanding what is already moving through the system.", chart: null },
];
...
export default function UnderTheHoodSupplyChain() {
  ...
  const BODY_JSX = {
    "intro": (() => {
      ...
      return (<>
        <p key={0} style={{ fontFamily: "'Source Sans 3', sans-serif", fontSize: '1rem', color: '#2C1810', lineHeight: 1.7, marginBottom: 18 }}>
