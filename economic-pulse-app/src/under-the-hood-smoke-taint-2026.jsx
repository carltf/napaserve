  ...
  return (
    <div style={{ background: T.bg, minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: isDraft ? "80px 20px 60px" : "60px 20px 60px" }}>
        ...
        <p style={P_STYLE}>
          Much of this research is federally funded, and that funding has been turbulent. At the task force’s 2025 summit, Tim Rinehart, the ARS national program leader who oversees the work, described an agency grape-research portfolio of about $27 million a year, of which roughly $5 million is directed to smoke exposure in winegrapes — money appropriated by Congress and shared with UC Davis, Oregon State and Washington State (<a href="https://grapeandwinemag.com/2025/10/08/2025-smoke-summit-research-and-support-continue-for-wine-industry-smoke-exposure-task-force/" target="_blank" rel="noopener noreferrer" style={LINK}>2025 summit</a>). He reaffirmed the roughly $5 million annual smoke figure at this year’s summit.
        </p>

        <ChartTwo />

        <p style={P_STYLE}>
          Earlier in 2025, federal staffing cuts briefly reached the smoke-taint program itself. Rumbaugh and other ARS grape researchers were among those terminated before the cuts were reversed (<a href="https://www.padilla.senate.gov/newsroom/press-releases/padilla-merkley-thompson-lamalfa-introduce-bipartisan-bicameral-bill-to-protect-winegrape-growers-against-wildfire-smoke-damage/" target="_blank" rel="noopener noreferrer" style={LINK}>Senate release</a>).
        </p>
        <p style={P_STYLE}>
          The agency is also reorganizing. USDA announced a department-wide restructuring in July 2025 that includes closing the Beltsville Agricultural Research Center in Maryland and relocating much of its Washington-area workforce to five regional hubs, a plan it reaffirmed in April 2026 (<a href="https://www.usda.gov/about-usda/news/press-releases/2025/07/24/secretary-rollins-announces-usda-reorganization-restoring-departments-core-mission-supporting" target="_blank" rel="noopener noreferrer" style={LINK}>USDA</a>). Rinehart told this year’s summit that the restructuring carried roughly $32 million in congressionally directed project terminations across ARS — about $20 million of it at Beltsville — though he said grape researchers were not directly affected, and pointed to fiscal 2027 House budget language that named smoke-exposure research and set aside $715,000 for it.
        </p>
        <p style={P_STYLE}>
          That in-house ARS work is separate from the proposed Smoke Exposure Research Act, the bipartisan bill described in “<a href="https://napavalleyfocus.substack.com/p/wine-chronicles-napa-braces-for-the" target="_blank" rel="noopener noreferrer" style={LINK}>Wine Chronicles: Napa Braces for the 2025 Fire Season</a>,” (June 5, 2025). Reintroduced in 2025 by Sens. Alex Padilla and Jeff Merkley and Reps. Mike Thompson and Doug LaMalfa, the bill would authorize $32.5 million over five years — $6.5 million a year from fiscal 2026 through 2030 — for dedicated smoke research at the three land-grant universities (<a href="https://www.govinfo.gov/content/pkg/BILLS-119hr2084ih/html/BILLS-119hr2084ih.htm" target="_blank" rel="noopener noreferrer" style={LINK}>bill text</a>). One stream funds the federal scientists through annual appropriations; the other would create a separate, longer-term authorization. Both run on the same uncertain political clock.
        </p>
        ...
        <p style={P_STYLE}>
          The test wine came from close to home. The 2025 Pickett Fire ignited Aug. 21 near Calistoga, burned 6,819 acres mostly within the footprint of the 2020 Glass Fire and threw smoke across Napa, Sonoma and Solano counties (<a href="https://www.fire.ca.gov/incidents/2025/8/21/pickett-fire" target="_blank" rel="noopener noreferrer" style={LINK}>CAL FIRE</a>). Arvik said a backfire lit beside a premier Napa Valley cabernet vineyard during that fire yielded fruit whose research wine ranked, by his account, among the most heavily smoke-affected wines ETS Laboratories in St. Helena had measured.
        </p>
        <p style={P_STYLE}>
        ...
        {/* ── DISCLOSURE ────────────────────────────────────────────── */}
        <p style={{ fontFamily: font, fontSize: 13, color: T.muted, fontStyle: "italic", lineHeight: 1.6, margin: "12px 0 0 0" }}>
          Disclosure: Alisa Jacobson, named in this article, owns{" "}
          <a href="https://www.turningtidewines.com/" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>Turning Tide Wines</a>.
        </p>
        ...
        <div style={{ borderTop: `1px solid ${T.border}`, marginTop: 40, paddingTop: 24 }}>
          ...
          <ol style={{ fontFamily: font, fontSize: 14, color: T.ink, lineHeight: 1.75, paddingLeft: 20 }}>
            ...
            <li style={{ marginBottom: 10 }}><a href="https://www.rma.usda.gov/about-crop-insurance/frequently-asked-questions/fire-insurance-protection-smoke-index-endorsement" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>USDA Risk Management Agency — FIP-SI endorsement</a>.</li>
