...
function KPI({label,value,delta}){
  return(
    <div style={{background:T.bg2,border:`1px solid ${T.rule}`,padding:"16px 18px",flex:1,minWidth:140,minHeight:120}}>
  ...
  if(loading)return(
    <div style={{minHeight:"100vh",background:T.bg,display:"flex",alignItems:"center",justifyContent:"center",fontFamily:"'Source Sans 3',sans-serif"}}>
      ...
      <div style={{textAlign:"center"}}>
        ...
        <style>{`@keyframes spin{to{transform:rotate(360deg)}} .dash-tabs::-webkit-scrollbar{display:none} .dash-tabs{scrollbar-width:none;-ms-overflow-style:none;} @media(max-width:768px){.kpi-grid-overview,.kpi-grid-macro,.kpi-grid-housing{display:grid!important;grid-template-columns:repeat(2,1fr)!important;gap:8px!important;overflow:hidden!important;align-items:stretch!important;flex-wrap:unset!important;}.kpi-grid-labor{display:grid!important;grid-template-columns:repeat(2,1fr)!important;gap:8px!important;overflow:hidden!important;align-items:stretch!important;flex-wrap:unset!important;}.kpi-grid-labor>*:last-child:nth-child(odd){grid-column:1/-1;}.kpi-grid-overview>*,.kpi-grid-macro>*,.kpi-grid-labor>*,.kpi-grid-housing>*{min-width:0!important;height:100%;}}`}</style>
