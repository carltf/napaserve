      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: isDraft ? "80px 20px 60px" : "60px 20px 60px" }}>
        ...
        <div style={{ borderTop: `1px solid ${T.border}`, marginTop: 40, paddingTop: 24 }}>
          ...
          <ol start="8" style={{ fontFamily: font, fontSize: 14, color: T.ink, lineHeight: 1.75, paddingLeft: 20 }}>
            ...
            <li style={{ marginBottom: 8 }}>
              Napa County, {"“"}<a href="https://napa.legistar.com/View.ashx?M=F%26ID=15410707%26GUID=9D28317D-C725-4EF5-98E0-A508DF952124" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>Attachment D {"—"} Recommended Conditions of Approval, P19-00038-MOD</a>{"”"} (April 28, 2026 hearing).
            </li>
            <li style={{ marginBottom: 8 }}>
