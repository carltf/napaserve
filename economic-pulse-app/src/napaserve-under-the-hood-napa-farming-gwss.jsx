    ...
    <div style={{ background: T.bg, minHeight: "100vh" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: isDraft ? "80px 20px 60px" : "60px 20px 60px" }}>
        ...
        <p style={{ ...prose, marginBottom: 18 }}>
          <span style={{ fontWeight: 700 }}>{DATELINE_LOCATION} —</span>{" "}On Tuesday, Napa County Agricultural Commissioner Tracy Cleveland confirmed that 220 grapevines shipped from Fresno County–based Burchell Nursery, Inc. to Costco Wholesale in Napa between April 21 and May 26 had been distributed to local consumers. Of those, 63 had already been destroyed by the time the county began its trace. The remaining 157 are unaccounted for. Inspectors recovered at least one viable GWSS egg mass on shipments associated with the same nursery channel. Similar shipments went to Costco locations and other retailers across Sonoma, Marin, Solano, Yolo and additional Northern California counties.
        </p>
        <p style={prose}>
          {"“"}GWSS is a devastating pest for our local vineyards, and it is critical for us to track down any potentially affected plants purchased at Costco or brought into Napa County,{"”"} Cleveland said in a statement coordinated with the county{"’"}s{" "}
          <a href="https://www.napacounty.gov/1278/Glassy-winged-Sharpshooter" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>public alert page</a>. {"“"}I am confident that the community will pull together to help us limit the risk to our local agriculture. Vigilance and prompt reporting are essential.{"”"}
        </p>
        ...
        {/* Photo 5 */}
        <img
          src="/photos/uth-napa-farming-gwss/photo-5.jpg"
          alt="Glassy-winged sharpshooter shown at scale, roughly half an inch"
        ...
        <p style={{ fontStyle: "italic", fontSize: 14, color: T.muted, marginTop: 0, marginBottom: 24 }}>
          Glassy-winged sharpshooter, the principal vector of Pierce{"'"}s disease, shown at scale. Adults measure roughly half an inch. — Features Graphic
        </p>
        ...
        <p style={prose}>
          Some growers are improvising. Buckland says he has put goats on blocks coming out where the ground was too wet to do mechanical groundwork and where spraying for mildew was too expensive — a low-cost, low-input substitute for a labor-intensive removal step.
        </p>
        ...
        />
        <p style={{ fontStyle: "italic", fontSize: 14, color: T.muted, marginTop: 0, marginBottom: 24 }}>
          The same Tubbs Lane vineyard from a different angle, irregular leaf-out across an established block — Tim Carl Photo
        </p>
        ...
        />
        <p style={{ fontStyle: "italic", fontSize: 14, color: T.muted, marginTop: 0, marginBottom: 24 }}>
          A vineyard at Silverado Trail and Old Toll Road in Calistoga — Tim Carl Photo
        </p>
        ...
        />
        <p style={{ fontStyle: "italic", fontSize: 14, color: T.muted, marginTop: 0, marginBottom: 24 }}>
          A cleared block at Silverado Trail and Highway 29 in Calistoga, removed vines stacked for burning, soil opened for whatever follows — replant, fallow or sale — Tim Carl Photo
        </p>
        ...
        {/* ── THE CLIMATE BACKDROP ────────────────────────── */}
        <h2 style={h2style}>The Climate Backdrop</h2>
        <p style={prose}>
          The pest pressure visible at the Napa Costco this month does not exist in isolation. It sits on top of a slow shift in the climate conditions that historically held many of these pathogens in check.
        </p>
        <p style={prose}>
          As I covered in{" "}
          <a href="https://napavalleyfocus.substack.com/p/under-the-hood-climate-changes-growing" target="_blank" rel="noopener noreferrer" style={{ color: T.accent, fontStyle: "italic" }}>Under the Hood: Climate Change{"’"}s Growing Impact on Napa Valley</a>{" "}
        ...
        <p style={prose}>
          Buckland has long predicted that the industry may be at risk of over-correction. {"“"}Lots of vineyards out, and a very light crop this year,{"”"} he said, describing the spring{"'"}s removal pace. The economic pressure is showing up alongside the disease pressure, and the response — pulling acres faster than the industry has historically pulled them — is creating its own dynamic.
        </p>
        ...
        {/* ── WHAT TO DO CALLOUT ──────────────────────────── */}
        <div style={{ background: T.surface, borderLeft: `3px solid ${T.accent}`, padding: "20px 24px", margin: "24px 0" }}>
          <h3 style={{ fontFamily: serif, fontSize: "1.15em", fontWeight: 700, color: T.ink, margin: "0 0 12px" }}>What to Do If You Purchased a Plant at Napa Costco in April or May</h3>
          <p style={prose}>
            The Napa County Agricultural Commissioner{"'"}s office asks that anyone who purchased a grapevine, citrus tree or other fruit tree at Napa Costco — or neighboring Costco locations — during April or May:
          </p>
          <ul style={{ fontFamily: font, fontSize: 17, lineHeight: 1.75, color: T.ink, paddingLeft: 24, marginBottom: 18 }}>
            <li>Keep the plant isolated in its original pot or container</li>
            <li>Do not plant the grapevine or tree if you have not already done so</li>
            <li>If possible, place the plant in two secured trash bags, one inside the other, and seal them closed</li>
            <li>Do not attempt to return, transport or relocate the plant</li>
            <li>Do not place the plant in the trash or a compost bin</li>
            <li>Immediately contact the Napa County Agricultural Commissioner{"'"}s Office at{" "}
              <a href="tel:7072534357" style={{ color: T.accent }}>707-253-4357</a> or{" "}
              <a href="mailto:agcommissioner@countyofnapa.org" style={{ color: T.accent }}>agcommissioner@countyofnapa.org</a>
            </li>
          </ul>
          <p style={prose}>
            An agricultural inspector will be dispatched the same day to examine the plant and any nearby host plants.
          </p>
          <p style={{ fontFamily: font, fontSize: 12, color: T.muted, fontStyle: "italic", marginBottom: 0 }}>
            Source:{" "}
            <a href="https://www.napacounty.gov/1278/Glassy-winged-Sharpshooter" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>Napa County Agricultural Commissioner</a>
          </p>
        </div>

        {/* ── REGULATORY FRAMEWORK SIDEBAR ──────────────────── */}
        <div style={{ background: T.surface, borderLeft: `3px solid ${T.accent}`, padding: "20px 24px", margin: "24px 0" }}>
          <h3 style={{ fontFamily: serif, fontSize: "1.15em", fontWeight: 700, color: T.ink, margin: "0 0 12px" }}>Regulatory Framework: Two Tracks</h3>
          <p style={prose}>
            The county{"'"}s response to the Costco GWSS shipment runs under one statutory framework — California Food and Agricultural Code Section 5401, which gives the agricultural commissioner authority over any pest-infested premises, plants or conveyances, including a retail location. That is the authority Cleveland is exercising when she dispatches inspectors to homes that may have purchased one of the 157 unaccounted vines.
          </p>
          <p style={{ ...prose, marginBottom: 0 }}>
            The abandoned-vineyards question Buckland raises sits one regulatory layer over.{" "}
            <a href="http://leginfo.legislature.ca.gov/faces/codesTOCSelected.xhtml?tocCode=FAC" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>Section 5551</a>{" "}
            of the same code, in place for decades, defines a neglected or abandoned crop as a public nuisance when it harbors pests or hosts. Section 5553 makes it unlawful to maintain such a crop. Enforcement runs through the county agricultural commissioner{"'"}s discretion. Layered on top of that baseline is Assembly Bill 732, authored by Assemblymember Alexandra Macedo of Tulare, chaptered October 7, 2025, and effective January 1, 2026. AB 732 gives county agricultural commissioners new authority to impose civil penalties — up to $500 per acre initially, rising to $1,000 per acre if a landowner fails to take good-faith corrective action within 45 days of the initial penalty issuance. Landowners who take corrective action within 30 days of receiving notice avoid the civil penalty entirely. The statute is crop-neutral by language, arising primarily from Central Valley pressures around abandoned orchard acreage but applying statewide to vineyards as well. The Napa Valley Grapegrowers has summarized grower-facing guidance in its{" "}
            <a href="https://www.napagrowers.org/bestpractices/best-practices-for-abandoned-and-neglected-vineyards" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>Best Practices for Abandoned and Neglected Vineyards</a>{" "}
            resource, published June 2025. {"“"}Not enough contractors to pull everything,{"”"} Buckland says, on why some neglected blocks remain on the landscape even with the rules in place.
          </p>
        </div>
        ...
        <div style={{ borderTop: `1px solid ${T.border}`, marginTop: 48, paddingTop: 24 }}>
          ...
          <ol style={{ fontFamily: font, fontSize: 14, color: T.ink, lineHeight: 1.75, paddingLeft: 20 }}>
            <li style={{ marginBottom: 10 }}><a href="https://www.napacounty.gov/1278/Glassy-winged-Sharpshooter" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>Napa County Agricultural Commissioner — Glassy-winged Sharpshooter alert page</a>.</li>
            ...
            <li style={{ marginBottom: 10 }}><a href="https://napavalleyfocus.substack.com/p/under-the-hood-climate-changes-growing" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>Under the Hood: Climate Change{"'"}s Growing Impact on Napa Valley — Napa Valley Features, August 2024</a>.</li>
            <li style={{ marginBottom: 10 }}><a href="https://www.northbaybiz.com/2021/12/02/vineyard-pests-a-game-of-whack-a-mole/" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>Vineyard Pests: A Game of Whack-a-Mole — NorthBay Biz, December 2021</a>.</li>
            <li style={{ marginBottom: 10 }}><a href="https://www.northbaybiz.com/2023/03/15/grapevine-pests-and-diseases-are-on-the-uptick/" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>Grapevine Pests and Diseases are On The Uptick — NorthBay Biz, March 2023</a>.</li>
