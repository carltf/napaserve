  ...
  return (
    <div style={{ background: T.bg, minHeight: "100vh", fontFamily: "'Source Sans 3', sans-serif" }}>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: isDraft ? "80px 20px 60px" : "60px 20px 60px" }}>
        ...
        <p style={{ ...prose }}>
          The Benessere estate — <a href="https://napavalleyfocus.substack.com/p/wine-chronicles-living-well-differently" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>profiled by Napa Valley Features</a> — includes roughly 29 acres of planted vines: Sangiovese as the flagship, alongside Sagrantino, Pinot Grigio, Aglianico and Falanghina, varietals rarely found elsewhere in Napa Valley, plus a working winery, a tasting room and two residences totaling more than 6,300 square feet of living space. The Benish family acquired the property in 1994 for $1.5 million after Charles Shaw, the brand behind Trader Joe's Two Buck Chuck, filed for bankruptcy. The family made the estate's focus on Italian varieties its identity. <a href="https://www.sfchronicle.com/food/wine/article/benessere-napa-valley-auction-22192134.php" target="_blank" rel="noopener noreferrer" style={{ color: T.accent }}>"If my dad were still around, I'm sure we'd still be going strong,"</a> John Benish told the San Francisco Chronicle. "We love the place, but I think in any big family, it's hard to get a consensus about what you want to do for the future."
        </p>
        <p style={{ ...prose }}>
