...
function Chart1() {
  ...
  return (<><div style={{display:"flex",gap:20,flexWrap:"wrap",marginBottom:10,fontSize:11,color:T.muted,fontFamily:"'Source Sans 3',sans-serif"}}><span><span style={{display:"inline-block",width:18,height:3,background:T.accent,marginRight:5,verticalAlign:"middle",borderRadius:1}}/>Wtd. avg. price per ton</span><span><span style={{display:"inline-block",width:10,height:10,borderRadius:"50%",background:"#E24B4A",marginRight:5,verticalAlign:"middle"}}/>2023 peak: $9,235</span><span><span style={{display:"inline-block",width:10,height:10,borderRadius:"50%",background:T.gold,marginRight:5,verticalAlign:"middle"}}/>2025 prelim.: $8,933</span></div><div style={{position:"relative",width:"100%",height:300}}><canvas ref={ref}/></div><button onClick={()=>{const c=ref.current;if(!c)return;const a=document.createElement("a");a.download="napa-cab-2025-chart-1.png";a.href=c.toDataURL("image/png");a.click();}} style={{marginTop:"8px",padding:"4px 12px",fontSize:"11px",fontFamily:"monospace",letterSpacing:"0.08em",color:"#8B7355",background:"transparent",border:"1px solid #D4C4A8",borderRadius:"3px",cursor:"pointer",display:"block"}}>DOWNLOAD CHART PNG</button></>);
}
...
function Chart2() {
  ...
  return (<><div style={{display:"flex",gap:16,flexWrap:"wrap",marginBottom:10,fontSize:11,color:T.muted,fontFamily:"'Source Sans 3',sans-serif"}}>{[["Actual",T.accent,false],["2000-2023 (4.75%·yr) \u2192 $10,134","#1D9E75",true],["1976-2023 (6.6%·yr) \u2192 $10,492","#BA7517",true],["2011-2019 (6.9%·yr from 2019) \u2192 $11,847","#E24B4A",true]].map(([l,c,d])=>(<span key={l} style={{display:"flex",alignItems:"center",gap:5}}><span style={{display:"inline-block",width:20,height:0,border:`2px ${d?"dashed":"solid"} ${c}`,verticalAlign:"middle"}}/>{l}</span>))}</div><div style={{position:"relative",width:"100%",height:300}}><canvas ref={ref}/></div><button onClick={()=>{const c=ref.current;if(!c)return;const a=document.createElement("a");a.download="napa-cab-2025-chart-2.png";a.href=c.toDataURL("image/png");a.click();}} style={{marginTop:"8px",padding:"4px 12px",fontSize:"11px",fontFamily:"monospace",letterSpacing:"0.08em",color:"#8B7355",background:"transparent",border:"1px solid #D4C4A8",borderRadius:"3px",cursor:"pointer",display:"block"}}>DOWNLOAD CHART PNG</button></>);
}
...
function Chart3() {
  ...
  return(<><div style={{display:"flex",gap:20,marginBottom:10,fontSize:11,color:T.muted,fontFamily:"'Source Sans 3',sans-serif"}}><span><span style={{display:"inline-block",width:10,height:10,borderRadius:2,background:"rgba(139,94,60,0.8)",marginRight:5,verticalAlign:"middle"}}/>Wtd. avg. (left axis)</span><span><span style={{display:"inline-block",width:10,height:10,borderRadius:2,background:"#E24B4A",marginRight:5,verticalAlign:"middle",opacity:0.8}}/>Max price paid (right axis)</span></div><div style={{position:"relative",width:"100%",height:300}}><canvas ref={ref}/></div><button onClick={()=>{const c=ref.current;if(!c)return;const a=document.createElement("a");a.download="napa-cab-2025-chart-3.png";a.href=c.toDataURL("image/png");a.click();}} style={{marginTop:"8px",padding:"4px 12px",fontSize:"11px",fontFamily:"monospace",letterSpacing:"0.08em",color:"#8B7355",background:"transparent",border:"1px solid #D4C4A8",borderRadius:"3px",cursor:"pointer",display:"block"}}>DOWNLOAD CHART PNG</button></>);
}
...
function Chart4() {
  ...
  return(<><div style={{display:"flex",gap:16,flexWrap:"wrap",marginBottom:10,fontSize:11,color:T.muted,fontFamily:"'Source Sans 3',sans-serif"}}>{[["Napa (D4)","rgba(139,94,60,0.85)"],["Sonoma (D3)","rgba(196,160,80,0.85)"],["Lake (D2)","rgba(44,24,16,0.45)"]].map(([l,c])=>(<span key={l} style={{display:"flex",alignItems:"center",gap:5}}><span style={{display:"inline-block",width:10,height:10,borderRadius:2,background:c}}/>{l}</span>))}</div><div style={{position:"relative",width:"100%",height:320}}><canvas ref={ref}/></div><button onClick={()=>{const c=ref.current;if(!c)return;const a=document.createElement("a");a.download="napa-cab-2025-chart-4.png";a.href=c.toDataURL("image/png");a.click();}} style={{marginTop:"8px",padding:"4px 12px",fontSize:"11px",fontFamily:"monospace",letterSpacing:"0.08em",color:"#8B7355",background:"transparent",border:"1px solid #D4C4A8",borderRadius:"3px",cursor:"pointer",display:"block"}}>DOWNLOAD CHART PNG</button></>);
}
...
function Chart5() {
  ...
  return <><div style={{position:"relative",width:"100%",height:260}}><canvas ref={ref}/></div><button onClick={()=>{const c=ref.current;if(!c)return;const a=document.createElement("a");a.download="napa-cab-2025-chart-5.png";a.href=c.toDataURL("image/png");a.click();}} style={{marginTop:"8px",padding:"4px 12px",fontSize:"11px",fontFamily:"monospace",letterSpacing:"0.08em",color:"#8B7355",background:"transparent",border:"1px solid #D4C4A8",borderRadius:"3px",cursor:"pointer",display:"block"}}>DOWNLOAD CHART PNG</button></>;
}
...
function Chart6() {
  ...
  return(<><div style={{display:"flex",gap:14,flexWrap:"wrap",marginBottom:10,fontSize:11,color:T.muted,fontFamily:"'Source Sans 3',sans-serif"}}>{[["White wine","rgba(196,160,80,0.75)"],["Red wine","rgba(139,94,60,0.85)"],["Table type","rgba(44,24,16,0.35)"],["Raisin type","rgba(44,24,16,0.55)"]].map(([l,c])=>(<span key={l} style={{display:"flex",alignItems:"center",gap:5}}><span style={{display:"inline-block",width:10,height:10,borderRadius:2,background:c}}/>{l}</span>))}</div><div style={{position:"relative",width:"100%",height:300}}><canvas ref={ref}/></div><button onClick={()=>{const c=ref.current;if(!c)return;const a=document.createElement("a");a.download="napa-cab-2025-chart-6.png";a.href=c.toDataURL("image/png");a.click();}} style={{marginTop:"8px",padding:"4px 12px",fontSize:"11px",fontFamily:"monospace",letterSpacing:"0.08em",color:"#8B7355",background:"transparent",border:"1px solid #D4C4A8",borderRadius:"3px",cursor:"pointer",display:"block"}}>DOWNLOAD CHART PNG</button></>);
}
