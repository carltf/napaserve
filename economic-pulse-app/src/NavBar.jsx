...
const NAV_GROUPS = [
  ...
  { label: "Community", desc: "Events, workforce and civic innovation", links: [{ t: "Event Finder", h: "/events" }, { t: "Public Notices", h: "/notices" }, { t: "Valley Works", h: "/valley-works" }, { t: "VW Labs", h: "/vw-labs" }] },
  { label: "Intelligence", desc: "Data, analysis and AI-assisted research", links: [{ t: "Community Pulse", h: "/dashboard" }, { t: "Maps & Atlases", h: "/maps" }, { t: "Project Evaluator", h: "/evaluator" }, { t: "Research Agent", h: "/agent" }, { t: "Models & Calculators", h: "/under-the-hood/calculators" }] },
