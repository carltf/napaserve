...
const EXPORT_DATA = {
  "napa-tax-base-2026": {
    ...
    body: [
      ...
      t("The remaining nine read as a roster of the wine economy and its property: Global Ag Properties/SPP Napa Vineyards, Robert Mondavi Properties under Constellation, Boardwalk Investments Yountville, E. & J. Gallo Winery, Heitz Wine Cellars, SRGA LP — the entity behind the Stanly Ranch resort in Carneros — Meritage Resort, Realty Income Properties 2 under Diageo and Treasury Wine Estates Americas. One of those 10, the Stanly Ranch resort, went into foreclosure in March 2026 — its hotel sold for $195 million — a reminder that even the hospitality names anchoring the tax roll aren’t immune to the reset."),
    ...
    sources: [
      "Napa County FY 2024-25 [Annual Comprehensive Financial Report (countyofnapa.org)](https://www.countyofnapa.org/1353/Annual-Comprehensive-Financial-Reports)",
      ...
      "[Napa Valley Register, Stanly Ranch foreclosure (SRGA LP)](https://napavalleyregister.com/news/napa-hotel-foreclosure-stanly-ranch-auberge-group/article_af89ef60-2410-4a75-9338-20c9baaf707e.html)",
      "[The Drinks Business, Treasury Wine Estates U.S. restructuring (June 2026)](https://www.thedrinksbusiness.com/2026/06/treasury-cuts-brands-in-bid-to-revive-growth/)",
    ],
    links: [
