...
const EXPORT_DATA = {
  "napa-population-2025": {
    ...
    body: [
      t("NAPA VALLEY, Calif. — The May 1 release from [California’s Department of Finance](https://dof.ca.gov/forecasting/demographics/estimates/e-1/) is the cleanest population data the state produces, and this year it tells a story Napa County has not heard since the COVID rebound. California declined. Napa County declined. And inside that decline, the geography of growth flipped."),
      ...
      t("A note on the data. The [May 2025 E-1 release](https://dof.ca.gov/forecasting/demographics/estimates/e-1/) benchmarked Napa County’s January 1, 2025 population at 136,124. The May 2026 release revises that figure upward to 136,620, then estimates the decline to 136,374. Department of Finance benchmarks every release back to the most recent census, which means the new vintage supersedes the old wherever they overlap. The comparisons in this piece use the revised series throughout."),
    ...
    sources: [
      "California Department of Finance, [E-1 Population Estimates, May 1, 2026](https://dof.ca.gov/forecasting/demographics/estimates/e-1/).",
      "California Department of Finance, E-1 Population Estimates, May 1, 2025.",
      "California Department of Finance, E-1 Population Estimates, May 2024.",
