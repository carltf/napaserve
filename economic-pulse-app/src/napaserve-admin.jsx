...
const EXPORT_DATA = {
  "napa-lodging-pricing-2026": {
    ...
    body: [
      ...
      t("The shape of that gap is seasonal. Through 2025, only one month — October — exceeded its 2019 demand baseline, at 103 percent. Five months landed within four points of 2019. The recovery is concentrated in fall and softens at the shoulders. January and February closed the year at 87 and 86 percent of 2019, the deepest gap in any month. Spring sits in between. The pattern is consistent with what high-end leisure travel markets have shown across coastal California: peak season is intact, off-season is not."),
      c(5),
      c(2),
    ...
    captions: [
      ...
      { number: 2, title: "Demand and rate, indexed to 2019", description: "Across six years, ADR rose 29 percent while demand fell 4 percent. The two lines diverged in 2021 and have not reconverged", source: "Smith Travel Research data via Visit Napa Valley monthly reports" },
