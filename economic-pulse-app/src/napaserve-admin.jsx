...
const EXPORT_DATA = {
  "napa-four-legged-economy-2026": {
    ...
    body: [
      ...
      t("Eight of the other nine are wine, vineyard real estate or hospitality holdings: Global Ag Properties/SPP Napa Vineyards, Robert Mondavi Properties under Constellation, Boardwalk Investments Yountville, E. & J. Gallo Winery, Heitz Wine Cellars, Meritage Resort, Realty Income Properties 2 LLC/Diageo and Treasury Wine Estates Americas. The seventh-ranked taxpayer, listed in the report only as SRGA, could not be independently identified. [VERIFY: SRGA — parcel lookup via the Napa County Assessor (John Tuteur, 707-253-4459) to confirm owner and sector.]"),
