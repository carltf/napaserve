...
const ARTICLES = [
  {
    ...
    headline: "Eighty-Seven Cents and Counting",
...
const EXPORT_DATA = {
  "napa-lodging-pricing-2026": {
    ...
    body: [
      ...
      t("[In October 2023, Napa Valley Features described](https://napavalleyfocus.substack.com/p/napa-valley-finds-itself-between) a region caught between a luxury-positioning strategy and a structural decline in volume. [In July 2025, this column ran the arithmetic of tasting rooms](https://napavalleyfocus.substack.com/p/under-the-hood-napas-tasting-rooms) — what it would actually take to recover 2023 revenue at 2025 order values — and found the figures untenable. [In August 2025, the column documented](https://napavalleyfocus.substack.com/p/under-the-hood-more-rooms-has-equaled) what had happened to hospitality employment since 2019: room counts up, jobs down. [In January 2026, the column showed](https://napavalleyfocus.substack.com/p/under-the-hood-price-continues-to) the same pattern in the lodging revenue line: rate up, demand sluggish. [In March 2026, the column noted the first simultaneous decline](https://napavalleyfocus.substack.com/p/when-room-price-can-no-longer-carry) in both occupancy and ADR since the pandemic. Two weeks later, in a different piece, [the column ran the GDP arithmetic](https://napavalleyfocus.substack.com/p/under-the-hood-napa-valleys-economy). Nominal county output had risen 35.8% since 2016. Real output had risen 4.6%. The remainder was the price level adjusting upward."),
    ...
    captions: [
      { number: 1, title: "Three surfaces, one pattern: Napa County, 2016–2026", description: "Across GDP, lodging revenue and hospitality jobs, the post-2019 decade has produced apparent growth driven by price, not volume", source: "Bureau of Economic Analysis (FRED); Smith Travel Research data via industry monthly reporting; Bureau of Labor Statistics" },
      { number: 2, title: "Demand vs. rate, indexed to Q1 2019 = 100", description: "The two lines diverged sharply after 2021. Hotel rates carried the post-pandemic recovery; demand has not closed the gap", source: "Smith Travel Research data via industry monthly reporting" },
      { number: 3, title: "Year-to-date March 2026 occupancy growth, California coastal markets", description: "Napa’s 1.8% trails every major peer, including Sonoma at 7.0% and San Francisco at 13.8%", source: "Smith Travel Research data via industry monthly reporting" },
    ...
    sources: [
      ...
      "Napa County Legistar File #26-215, [\"Inn at the Abbey Use Permit Modification,\"](https://napa.legistar.com/LegislationDetail.aspx?ID=7991995) April 28, 2026.",
