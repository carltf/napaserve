...
const ARTICLES = [
  {
    ...
    headline: "Under the Hood: Napa County's $996 Million Budget Leans on a Softening Tax Base",
  ...
  },
  {
    ...
    headline: "Under the Hood: Napa County's Schools Held Flat. Three Different Stories Made the Number.",
    publication: "Napa Valley Features",
    date: "May 21, 2026",
  },
  {
...
const EXPORT_DATA = {
  "napa-county-budget-2027": {
    ...
    captions: [
      {
        ...
        sources: [{ label: "Napa County FY 2026-27 Adopted Budget, Appropriations - All Funds", url: "https://www.napacounty.gov/3726/Budget-in-Brief" }],
      },
      {
        number: 2,
        title: "Nearly Two-Thirds of the General Fund Rides on Taxes",
        description: "Nearly two-thirds of the county's projected $312.0 million in general fund revenue comes from taxes.",
        sources: [{ label: "Napa County FY 2026-27 Adopted Budget, General Fund revenue by source", url: "https://www.napacounty.gov/3726/Budget-in-Brief" }],
      },
      {
        number: 3,
        title: "All Three Tax Estimates Set Below Last Year's Budget",
        ...
        sources: [{ label: "Napa County FY 2026-27 Adopted Budget and Budget in Brief", url: "https://www.napacounty.gov/3726/Budget-in-Brief" }],
      },
      {
        number: 4,
        title: "The Share of Property Taxes Paid On Time Has Slipped",
        ...
        sources: [{ label: "Napa County FY 2026-27 Adopted Budget, Treasurer-Tax Collector performance measures", url: "https://www.napacounty.gov/3726/Budget-in-Brief" }],
      },
      {
        number: 5,
        title: "Most of the General Fund Is People",
        ...
        sources: [{ label: "Napa County FY 2026-27 Adopted Budget, General Fund expenditure appropriations", url: "https://www.napacounty.gov/3726/Budget-in-Brief" }],
      },
    ],
    relatedCoverage: [
      { title: "Under the Hood: Napa County's Tax Base Begins to Wobble", publication: "Napa Valley Features", date: "July 2, 2026", url: "https://napaserve.org/under-the-hood/napa-four-legged-economy-2026" },
      ...
      { title: "Under the Hood: When the Price Gives Way", publication: "Napa Valley Features", date: "April 16, 2026", url: "https://napaserve.org/under-the-hood/napa-price-discovery-2026" },
    ...
    substackPolls: [
      { question: "Napa County's budget sets property, sales and lodging taxes below last year. What is the biggest risk?", options: ["Cuts to county services", "Draining reserves over time", "Less money for capital projects", "Higher local taxes or fees", "Too early to tell"] },
      { question: "The county's tax base grew on real estate, not wages. How much does that concern you?", options: ["A serious long-term risk", "A concern worth watching", "Manageable with strong reserves", "Not a real problem", "Unsure"] },
      { question: "Where do you think Napa County's tax revenue heads over the next two years?", options: ["Rebounds, this is the bottom", "Stays about flat", "Keeps softening slowly", "Falls as assets reprice", "Unsure"] },
    ],
    sources: [
      "Napa County FY 2026-27 [Adopted Budget and Budget in Brief](https://www.napacounty.gov/3726/Budget-in-Brief) (napacounty.gov)",
      "Napa County FY 2024-25 [Annual Comprehensive Financial Report](https://www.napacounty.gov/308/County-Financial-and-Budget-Reports) — assessed value, transient-occupancy-tax actuals and top taxpayers",
      "Napa County median household income, U.S. Census Bureau American Community Survey, via [Data USA](https://datausa.io/profile/geo/napa-county-ca)",
    ],
    links: [
      { label: "Read interactive version", url: "https://napaserve.org/under-the-hood/napa-county-budget-2027" },
    ],
  },
  "napa-lodging-spring-2026": {
    ...
    body: [
      ...
      t("The contrast with Sonoma County, whose 2026 lodging rebound has run on volume rather than rate, has only sharpened. Through May, Sonoma’s occupancy was up 6.4% year to date while its average daily rate rose just 0.9%. Napa’s occupancy was up 0.4% while its rate rose 3.6%."),
      c(2),
    ...
    relatedCoverage: [
      ...
      { title: "Price Continues to Carry Napa Hotel Market as Room-Night Demand Lags", publication: "Napa Valley Features", date: "January 2026", url: "https://napavalleyfocus.substack.com/p/under-the-hood-price-continues-to" },
      { title: "Napa County’s Last Stable Leg Is Showing Cracks", publication: "Napa Valley Features", date: "July 1, 2026", url: "https://napaserve.org/under-the-hood/napa-four-legged-economy-2026" },
    ],
    substackPolls: [
  ...
  "napa-four-legged-economy-2026": {
    ...
    captions: [
      {
        ...
        sources: [
          ...
          { label: "Napa County Agricultural Commissioner crop reports, 2021-2024", url: "" },
        ],
      },
      {
        number: 2,
    ...
    relatedCoverage: [
      ...
      { title: "Under the Hood: How Accelerants — From GLP-1s to Politics — Are Reshaping Wine Demand", publication: "Napa Valley Features", date: "January 22, 2026", url: "https://napavalleyfocus.substack.com/p/under-the-hood-the-accelerants-reshaping" },
      { title: "Under the Hood: Napa Valley’s Economy Looks Bigger Than It Is", publication: "Napa Valley Features", date: "March 2026", url: "https://napaserve.org/under-the-hood/napa-gdp-2024" },
    ],
    substackPolls: [
      { question: "Three of Napa County’s four economic legs — wine, tourism and hospitality jobs — are slipping while property tax holds. What happens to the fourth leg next?", options: ["It holds — real estate values stay elevated", "It softens as distressed sales reprice the roll", "It drops sharply once reassessments catch up", "Too uncertain to call", "Other (comment below)"] },
      { question: "A tax base that keeps climbing on real estate while wine, tourism and jobs all weaken is a sign of growing fragility, not strength.", options: ["Strongly agree", "Agree", "Neutral / Unsure", "Disagree", "Strongly disagree"] },
    ...
    sources: [
      "Napa County FY 2024-25 [Annual Comprehensive Financial Report](https://www.napacounty.gov/308/County-Financial-and-Budget-Reports) (napacounty.gov)",
      "Napa County [Agricultural Commissioner crop reports](https://www.napacounty.gov/258/Crop-Reports), 2021-2024 (2024 report released May 20, 2025)",
      "Napa County FY 2024-25 [ACFR](https://www.napacounty.gov/308/County-Financial-and-Budget-Reports), Auditor-Controller’s Office (10 Largest Taxpayers schedule) and Principal Employers schedule",
      "Treasury Wine Estates “Ascent” restructuring: San Francisco Chronicle (June 17, 2026); [The Drinks Business](https://www.thedrinksbusiness.com/2026/06/treasury-cuts-brands-in-bid-to-revive-growth/) (June 2026); TWE investor day, June 4, 2026",
      "TWE St. Helena/Beringer luxury-hub history: [Wines & Vines](https://winesvinesanalytics.com/template.cfm?content=171031&section=features) (2016 Diageo-acquisition consolidation at the Beringer plant, Pratt Avenue)",
      "Benessere Vineyards auction: [Press Democrat](https://www.pressdemocrat.com/2026/06/25/napa-valley-winery-benessere-vineyards-auction-closes/) / North Bay Business Journal (June 25, 2026); [Concierge Auctions release](https://www.einpresswire.com/article/922449025/napa-vineyard-estate-pending-sale-for-10-15m-in-77-days-via-concierge-auctions-new-global-wine-vineyards-division) (June 26, 2026)",
      "Stanly Ranch / Blackstone and Calistoga Motor Lodge default: [Napa County Shrunk as Calistoga Grew and the Base Faltered](https://napaserve.org/under-the-hood/napa-population-2025) (May 14, 2026) and [How Accelerants Are Reshaping Wine Demand](https://napavalleyfocus.substack.com/p/under-the-hood-the-accelerants-reshaping) (Jan. 22, 2026)",
      "SRGA / Stanly Ranch identity confirmed by the Napa County Assessor (John Tuteur); ownership and foreclosure per Napa County records, Press Democrat (Oct. 28, 2025) and Napa Valley Register (Oct. 2025)",
    ],
    links: [
      { label: "Read interactive version", url: "https://napaserve.org/under-the-hood/napa-four-legged-economy-2026" },
    ],
  },
  "napa-auction-2026": {
    ...
    body: [
      ...
      t("A year ago [in this space](https://napavalleyfocus.substack.com/p/under-the-hood-auction-napa-valleys), we wrote that the auction's prestige and price-setting influence could no longer be assumed — that it would have to be re-earned each year. The 2026 weekend is the first real test of that, and it split the difference: the enthusiasm was re-earned, the dollars were not."),
      t("That single data point is worth holding up against everything else moving through the valley this spring."),
      h("Still a Fraction of Peak"),
      t("The nominal totals tell a long-arc story that one strong weekend doesn't change."),
      c(1),
      t("By Napa Valley Features' inflation-adjusted analysis, using a 2014 base and U.S. Bureau of Labor Statistics CPI, this year's $6 million translates to approximately $4.2 million in 2014 dollars, or about 23% of the inflation-adjusted peak. Last year's $6.5 million came to approximately $4.84 million in 2014 dollars, or 26% of that peak. In real terms, then, 2026 didn't just stall — it gave back a share of the ground 2025 had recovered."),
      h("A Sold-Out Crowd, a Smaller Total"),
      t("The interesting tension is that demand for the experience held while the dollars did not. “If there is a slump in interest in wine, we aren't seeing it here,” Napa Valley Vintners' Teresa Wall told guests at Friday's barrel auction, and the attendance figures back her up. The weekend honored founder Robin Lail with a lifetime achievement award, drew Francis Ford Coppola to his Inglenook estate, and featured top live lots built around shared experiences — an evening with Sebastian Maniscalco from Gargiulo Vineyards, B Cellars and Silver Oak, and a tribute dinner to the late winemaker Michel Rolland organized by Staglin Family Vineyards, Accendo Estate, Dalla Valle Vineyards, Darioush and Screaming Eagle."),
      t("What softened was not the room's enthusiasm but its checkbook. A packed, generous crowd raised less than a smaller field did a year earlier. That is the signal worth sitting with: the auction is increasingly good at filling seats and less able to translate those seats into the totals it once commanded. Forbes captured the prevailing mood among vintners as [glass half full](https://www.winebusiness.com/news/link/319021), and Tom Eddy, who has made wine in the valley since 1974, called it “the fifth major downturn” of his career while voicing confidence in the long run. Optimism and a declining total are not contradictions here. They are the same story told from two ends."),
      h("A Crowded Field"),
      t("Part of the math is competition. The national charity-wine landscape has expanded well past the model Napa invented in 1981. The Naples Winter Wine Festival has been raising tens of millions annually, the Sonoma County Wine Auction and the V Foundation's Wine Celebration have built loyal donor bases, and financial-center sales through Sotheby's and Christie's now compete for the same collectors. Napa is no longer measured against its own history alone but against a field it helped create — one where a single Florida weekend can out-raise Napa's entire three days several times over."),
      h("The Reset Around the Edges"),
      t("The auction doesn't sit apart from the wine economy; it's a barometer of it. And this spring the other instruments are reading the same direction."),
      t("Silicon Valley Bank's [June Direct-to-Consumer report](https://www.svb.com/trends-insights/reports/wine-report/) found Napa tasting-room reservations down on a trailing-12-month basis and club membership off 4% in 2025, with author Rob McMillan describing the moment as “stabilization, not recovery.” At a North Bay Business Journal-covered conference in May, M&A specialist Mario Zepponi and land appraiser Tony Correia described an industry in [a painful structural reset rather than a short-term slump](https://napaserve.org/under-the-hood/napa-structural-reset-2026), with a recovery horizon Zepponi put near 2028. Around them, [the distress has been concrete and named](https://www.napaserve.org/under-the-hood/calculators#tracker): the Alila Napa Valley resort's $94.2 million default, the Calistoga Motor Lodge's $40 million default, Stanly Ranch's $195 million foreclosure sale, Benessere Vineyards forced to auction after failing to sell at $35 million and Alpha Omega's Mount Veeder vineyard pushed toward foreclosure."),
      t("Against that backdrop, a charity weekend that raised $6 million on sold-out tickets reads less like an outlier than like confirmation. The appetite for Napa as an experience is intact. The dollars that experience generates are not what they were — and they are still searching for a floor."),
      h("Influence Without Oversight"),
      t("The structural questions raised in this space before have not gone away, and a softer total sharpens them. Auction proceeds fund the Youth Wellness Initiative, channeled through partners including Mentis, the Boys & Girls Clubs, On the Move, UpValley Family Centers and others — services that vineyard and hospitality workers and their families rely on. Napa Valley Vintners reports more than $245 million given to the community since 1981."),
      t("But the funding still flows largely as one-time grants, allocated by a committee whose full composition and independent community oversight remain unclear from public materials. When the same industry that depends on these services also controls the philanthropic dollars that sustain them, the tension between public benefit and private interest is structural, not incidental — and it grows more pointed in a year when the pool of dollars shrinks. The idea we raised here last year — an independently governed Napa Valley Community Fund, able to receive auction proceeds while broadening who participates in funding decisions — is worth revisiting precisely now."),
      h("Looking Ahead"),
      t("The experience is not the problem; the economics are. A sold-out weekend that raised less than a smaller one tells you demand is healthy and yield is not. For an industry pricing itself as luxury, that gap is the thing to watch."),
    ...
    captions: [
      {
        number: 1,
        title: "Auction Napa Valley Totals: Nominal vs. Inflation-Adjusted, 2012-2026",
    ...
    substackPolls: [
      { question: "What does the $6M total signal to you?", options: ["A temporary wobble", "The start of a real decline", "Demand strong, pricing weak", "Healthy correction from peak", "Too soon to read into it"] },
      { question: "A sold-out weekend raised less than 2025. Why?", options: ["Donor fatigue, smaller checks", "Broader wine-economy slump", "More competing auctions", "Fewer ultra-high-end lots", "Normal year-to-year noise"] },
      { question: "Should auction proceeds be governed independently?", options: ["Yes, create a community fund", "Yes, add outside oversight", "Keep it with the Vintners", "Unsure, need more detail", "No, current model works"] },
    ],
    sources: [
      "Napa Valley Vintners / Collective Napa Valley release, “Enthusiasm for Wine Turns Into Impact at Auction Napa Valley” (June 7, 2026)",
      "Wine Spectator: [Auction Napa Valley Pours It Forward](https://www.winespectator.com/articles/auction-napa-valley-pours-it-forward)",
      "Forbes, Liz Thach, “A Glass Half Full at Auction Napa Valley” (Tom Eddy quote): [winebusiness.com](https://www.winebusiness.com/news/link/319021)",
      "Collective Napa Valley, 2026 Auction Weekend ticketing ($5,000 per guest): [collectivenapavalley.org](https://www.collectivenapavalley.org/events/2026-complete-auction-weekend/)",
      "Silicon Valley Bank, June 2026 Direct-to-Consumer Wine Report: https://www.svb.com/trends-insights/reports/wine-report/",
      "North Bay Business Journal, May 2026 conference (Zepponi, Correia); see [The Reset Spreads](https://napaserve.org/under-the-hood/napa-structural-reset-2026)",
      "U.S. Bureau of Labor Statistics, CPI-U (2014 base; May 2026 = 335.123): [bls.gov/cpi](https://www.bls.gov/cpi/)",
    ],
    links: [
      { label: "Read interactive version", url: "https://napaserve.org/under-the-hood/napa-auction-2026" },
    ],
  },
  ...
  "smoke-taint-2026": {
    ...
    relatedCoverage: [
      { title: "Bracing for the Blaze: The Wine Industry Prepares to Battle Smoke Taint", publication: "Napa Valley Features", date: "July 27, 2023", url: "https://napavalleyfocus.substack.com/p/bracing-for-the-blaze-the-wine-industry" },
      { title: "Wine Chronicles: Napa Braces for the 2025 Fire Season", publication: "Napa Valley Features", date: "June 5, 2025", url: "https://napavalleyfocus.substack.com/p/wine-chronicles-napa-braces-for-the" },
      { title: "Napa County’s Newest Ridge-Top Firebreak, Built Parcel by Parcel", publication: "Napa Valley Features", date: "May 20, 2026", url: "https://napavalleyfocus.substack.com/p/napa-countys-newest-ridge-top-firebreak" },
      { title: "Under the Hood: Fighting Fire With Fire", publication: "Napa Valley Features", date: "May 4, 2024", url: "https://napavalleyfocus.substack.com/p/under-the-hood-fighting-fire-with" },
      { title: "Under the Hood: Living With Fire in Northern California’s Wine Country", publication: "Napa Valley Features", date: "Sept. 28, 2024", url: "https://napavalleyfocus.substack.com/p/under-the-hood-living-with-fire-in" },
    ],
    substackPolls: [
      { question: "What worries you most about the 2026 smoke season?", options: ["Smoke taint in the fruit", "Lab vs taste mismatch", "Insurance not paying out", "Research funding cuts", "Another major wildfire"] },
      { question: "Which smoke defense do you trust most?", options: ["Small-batch test ferments", "Barrier sprays in the field", "Cellar remediation later", "Crop insurance coverage", "Nothing reliable yet"] },
      { question: "Where should the fix come first?", options: ["Better detection science", "Clearer insurance rules", "Steady federal funding", "On-vineyard prevention", "Faster lab turnaround"] },
    ],
    sources: [
      "[2026 West Coast Smoke Summit (recording)](https://www.youtube.com/watch?v=G0qrPynJd1w)",
      "[Australian Wine Research Institute — Sensory impact of smoke exposure](https://www.awri.com.au/sensory-impact-of-smoke-exposure/)",
      "[USDA Agricultural Research Service — 2025 Smoke Summit coverage](https://grapeandwinemag.com/2025/10/08/2025-smoke-summit-research-and-support-continue-for-wine-industry-smoke-exposure-task-force/)",
      "[H.R. 2084 — Smoke Exposure Research Act (bill text)](https://www.govinfo.gov/content/pkg/BILLS-119hr2084ih/html/BILLS-119hr2084ih.htm)",
      "[USDA reorganization announcement (July 2025)](https://www.usda.gov/about-usda/news/press-releases/2025/07/24/secretary-rollins-announces-usda-reorganization-restoring-departments-core-mission-supporting)",
      "[Sens. Padilla, Merkley and Reps. Thompson, LaMalfa — winegrape smoke bill release](https://www.padilla.senate.gov/newsroom/press-releases/padilla-merkley-thompson-lamalfa-introduce-bipartisan-bicameral-bill-to-protect-winegrape-growers-against-wildfire-smoke-damage/)",
      "[USDA Risk Management Agency — FIP-SI endorsement](https://www.rma.usda.gov/about-crop-insurance/frequently-asked-questions/fire-insurance-protection-smoke-index-fip-si)",
      "[CAL FIRE — Pickett Fire incident](https://www.fire.ca.gov/incidents/2025/8/21/pickett-fire)",
    ],
    links: [
      { label: "Read interactive version", url: "https://napaserve.org/under-the-hood/smoke-taint-2026" },
    ],
  },
  ...
  "napa-farming-2026-gwss": {
    headline: "Under the Hood: A Tough Year on Napa’s Farms, and a Pest That Could Make It Worse",
    publication: "Napa Valley Features",
    deck: "One hundred fifty-seven grapevines are unaccounted for, the valley is already losing ground to disease and removals, and the question is no longer whether the over-correction comes — it is when.",
    summary: "On May 26, the Napa County Agricultural Commissioner’s office confirmed that grapevines sold at the Napa Costco between April 21 and May 26 may carry the glassy-winged sharpshooter, a vector of the deadly Pierce’s disease. One hundred and fifty-seven of 220 plants are unaccounted for. The detection arrives in a year already defined by accelerating vineyard removals, elevated disease pressure across multiple crops and a light grape crop. For viticulturist Garrett Buckland, who has spent the past two years arguing that California’s vineyard contraction will eventually swing past balance into shortage, the question is no longer whether the over-correction comes. It is when.",
    slug: "napa-farming-2026-gwss",
    dateline: "NAPA VALLEY, Calif. — May 26, 2026",
    body: [
      t("NAPA VALLEY, Calif. — On Tuesday, Napa County Agricultural Commissioner Tracy Cleveland confirmed that 220 grapevines shipped from Fresno County–based Burchell Nursery, Inc. to Costco Wholesale in Napa between April 21 and May 26 had been distributed to local consumers. Of those, 63 had already been destroyed by the time the county began its trace. The remaining 157 are unaccounted for. Inspectors recovered at least one viable GWSS egg mass on shipments associated with the same nursery channel. Similar shipments went to Costco locations and other retailers across Sonoma, Marin, Solano, Yolo and additional Northern California counties."),
      t("“GWSS is a devastating pest for our local vineyards, and it is critical for us to track down any potentially affected plants purchased at Costco or brought into Napa County,” Cleveland said in a statement coordinated with the county’s [public alert page](https://www.napacounty.gov/1278/Glassy-winged-Sharpshooter). “I am confident that the community will pull together to help us limit the risk to our local agriculture. Vigilance and prompt reporting are essential.”"),
      h("Why This Detection Matters More Than Usual"),
      t("GWSS has been a known California problem since 1989, when it was first identified in Orange and Ventura counties, and a state quarantine has restricted nursery-stock movement from infested southern counties ever since. CDFA reports that the pest spreads primarily as egg masses on nursery stock and feeds on a wide range of hosts, including citrus, almond and ornamental plants. According to [UC Statewide IPM](http://ipm.ucanr.edu/PMG/PESTNOTES/pn7492.html), once GWSS is established in an area, there are no effective cultural controls available to manage it."),
      t("[Photo 5: Glassy-winged sharpshooter, the principal vector of Pierce’s disease, shown at scale. Adults measure roughly half an inch. — Features Graphic]"),
      t("What gives this Napa Costco detection a sharper edge is the channel. Retail-sold nursery stock sits outside the trade’s normal inspection and quarantine flow. The 220-plant shipment moved through a consumer entry point that the state’s GWSS containment system was not built to police in real time. The detection rate at retail is a function of how hard county inspectors look and how visible the life stage happens to be when they do."),
      t("The Costco detection is not the first signal that climate and trade pressures are widening Pierce’s disease risk in Napa. The column *[Climate Change’s Growing Impact on Napa Valley](https://napavalleyfocus.substack.com/p/under-the-hood-climate-changes-growing)* (August 2024) documented how warmer winter nights have expanded GWSS populations and pushed grapevine red blotch disease deeper into the valley. The retail nursery-stock pathway is a new variable on top of a baseline that was already moving in the wrong direction."),
      h("What the Fields Look Like Right Now"),
      t("Drive the valley in late May and the variation across blocks tells most of the story."),
      t("Some of the more unusual canopy signatures across the valley this spring — uneven leaf-out, rust-brown rows, what looks at first glance like disease — are deliberate. Growers preparing blocks for removal are applying high rates of sulfur on hot days to strip the canopy, then leaving the wood to dry before the rip-out. “Will make a cleaner burn pile,” Buckland says. “No leaves, no mildew.”"),
      t("[Photo 1: A vineyard at the corner of Highway 128 and Tubbs Lane in Calistoga in late May — Tim Carl Photo]"),
      t("Healthy, actively farmed rows can sit immediately adjacent to blocks that have not been pruned, irrigated or cleaned up. In some cases, a block looks uniformly browned and leafless — a condition that, at a glance, suggests glyphosate application in preparation for tear-out."),
      t("The appearance is misleading. Garrett Buckland — a partner at Premiere Viticultural Services, the Napa Valley Grapegrowers’ 2023 Grower of the Year and a member of the organization’s board — said the brown-canopy pattern visible across several blocks this spring is the result of a deliberate technique, not herbicide."),
      t("“Looks like they burned the canopy on purpose,” Buckland said in response to photos sent from a recent valley drive. “No leaves, no mildew. You could just do a high rate of sulfur on a hot day to burn off the canopy. Doesn’t look like a weed spray, but that’s an option too.”"),
      t("The economic logic is straightforward. A clean, leafless block makes for “a cleaner burn pile” when the vines are pulled, Buckland said, and it is cheaper than continuing to spray for mildew on a block that will not produce a crop. On blocks too wet to do the groundwork conventionally, he has put goats on the vineyard. “Cheaper than spraying for mildew,” he said."),
      t("Some growers are improvising. Buckland says he has put goats on blocks coming out where the ground was too wet to do mechanical groundwork and where spraying for mildew was too expensive — a low-cost, low-input substitute for a labor-intensive removal step."),
      t("[Photo 2: The same Tubbs Lane vineyard from a different angle, irregular leaf-out across an established block — Tim Carl Photo]"),
      t("Other blocks are partially leafed out but show stressed canopies, with brown patches mixed through green growth."),
      t("[Photo 3: A vineyard at Silverado Trail and Old Toll Road in Calistoga — Tim Carl Photo]"),
      t("Up close, the pattern looks less like a uniform spray-down and more like vines under specific stress: dead canes, scattered new growth, irregular leaf-out across an otherwise structured trellis."),
      t("[Photo 4: A cleared block at Silverado Trail and Highway 29 in Calistoga, removed vines stacked for burning, soil opened for whatever follows — replant, fallow or sale — Tim Carl Photo]"),
      t("In other places, full rows have been cleared, the canopy stripped down and the block readied for what comes next — replant, fallow or sale."),
      t("“Lots of vineyards out, and a very light crop this year,” Buckland said. He added that the pace of removal has outrun the contracting capacity to keep up with it: “Not enough contractors to pull everything.”"),
      h("A Public Nuisance, Defined"),
      t("A vineyard mid-removal can resemble an abandoned one for weeks or months. The distinction matters legally and ecologically."),
      t("Under [California Food and Agricultural Code Section 5551](http://leginfo.legislature.ca.gov/faces/codesTOCSelected.xhtml?tocCode=FAC), a neglected or abandoned crop can be declared a public nuisance when it harbors pests, threatens regional agriculture or hosts quarantine species. County Agricultural Commissioners have the authority to investigate, issue notices and pursue abatement. Buckland said the relevant rules require basic maintenance and nuisance mitigation at the Ag Commissioner’s discretion, and noted that a more recent state law specifically addresses neglected vineyards."),
      t("The Napa Valley Grapegrowers’ [Best Practices for Abandoned and Neglected Vineyards](https://www.napagrowers.org/bestpractices/best-practices-for-abandoned-and-neglected-vineyards) guide, updated in June 2025, lays out the practical stakes. Unmaintained blocks become reservoirs for trunk diseases such as Eutypa, Botryosphaeria and Esca, host populations of leafhoppers, mealybugs and sharpshooters that vector Pierce’s disease and leafroll virus and provide habitat for rodents and invasive weeds. The guide also notes that a block slated for removal can temporarily resemble an abandoned site, and asks owners to communicate with neighbors and the Ag Commissioner if removal is delayed."),
      h("Regulatory Framework: Two Tracks"),
      t("The county’s response to the Costco GWSS shipment runs under one statutory framework — California Food and Agricultural Code Section 5401, which gives the agricultural commissioner authority over any pest-infested premises, plants or conveyances, including a retail location. That is the authority Cleveland is exercising when she dispatches inspectors to homes that may have purchased one of the 157 unaccounted vines."),
      t("The abandoned-vineyards question Buckland raises sits one regulatory layer over. [Section 5551](http://leginfo.legislature.ca.gov/faces/codesTOCSelected.xhtml?tocCode=FAC) of the same code, in place for decades, defines a neglected or abandoned crop as a public nuisance when it harbors pests or hosts. Section 5553 makes it unlawful to maintain such a crop. Enforcement runs through the county agricultural commissioner’s discretion. Layered on top of that baseline is Assembly Bill 732, authored by Assemblymember Alexandra Macedo of Tulare, chaptered October 7, 2025, and effective January 1, 2026. AB 732 gives county agricultural commissioners new authority to impose civil penalties — up to $500 per acre initially, rising to $1,000 per acre if a landowner fails to take good-faith corrective action within 45 days of the initial penalty issuance. Landowners who take corrective action within 30 days of receiving notice avoid the civil penalty entirely. The statute is crop-neutral by language, arising primarily from Central Valley pressures around abandoned orchard acreage but applying statewide to vineyards as well. The Napa Valley Grapegrowers has summarized grower-facing guidance in its [Best Practices for Abandoned and Neglected Vineyards](https://www.napagrowers.org/bestpractices/best-practices-for-abandoned-and-neglected-vineyards) resource, published June 2025. “Not enough contractors to pull everything,” Buckland says, on why some neglected blocks remain on the landscape even with the rules in place."),
      h("The Removal Numbers"),
      t("The field conditions sit on top of a statewide trend that is now in its third year."),
      t("[Chart 1: California Winegrape Acreage by Bearing Status, 2023–2025 — Total California winegrape acreage fell 11.5% over two years, but the contraction was uneven: bearing acreage declined 5.6% year over year in 2025, while non-bearing acreage — vines planted in the past three years and not yet producing fruit — fell 25%. The collapse in non-bearing acreage is the leading indicator of replant pullback. Preliminary figures pending the 2025 crush report and GIS verification. Source: USDA NASS / CDFA California Grape Acreage Report, April 22, 2026.]"),
      t("Preliminary figures from the Land IQ report commissioned by the California Association of Winegrape Growers put Napa removals at approximately 3,100 acres between October 2024 and August 2025, alongside an estimated 38,000 acres removed statewide over the same period. Industry forecaster Jeff Bitter projected 40,000 or more statewide removals for 2026. These are preliminary numbers. A definitive accounting will require GIS-satellite mapping and the 2025 crush report, expected in early 2026 — a methodological caution this publication has previously raised in its coverage of *[Under the Hood: The Dismal Math of Napa’s Unharvested Acres](https://napavalleyfocus.substack.com/p/under-the-hood-the-dismal-math-of)*."),
      t("[Chart 2: California Winegrape Removals by County, October 2024 – August 2025 — San Joaquin led California with 7,796 acres removed, followed by Fresno at 6,250 and Monterey at 3,781. Napa removed 3,117 acres — roughly 7.7% of the county’s winegrape footprint. Source: 2025 Standing Winegrape Acreage Report, Land IQ for CAWG.]"),
      t("The April 22, 2026 [USDA NASS / CDFA California Grape Acreage Report](https://www.edhat.com/california/news/californias-wine-grape-acreage-drops-in-2025-as-industry-struggles-continue-new-report-shows/) estimated California’s total winegrape acreage at 540,000 acres in 2025, down from 580,000 in 2024 and 610,000 in 2023. Bearing acreage fell 5.6% year over year. Non-bearing acreage fell 25%."),
      t("Jeff Bitter, president of Allied Grape Growers, told the Unified Wine and Grape Symposium in late January that [another 40,000 acres are expected to come out in 2026](https://www.farmprogress.com/grapes/california-on-track-to-raze-another-40-000-acres-of-vineyards). He estimated that [8,000 acres in Napa County — roughly 20% of the county’s vineyard footprint — went unharvested in 2025](https://napacountytimes.com/napa-valley-grapes-were-left-on-the-vine-this-harvest-while-acres-of-vineyards-have-been-pulled-over-the-past-year/)."),
      t("Readers can model the per-acre and regional economic impact of these removals with the [Vineyard Acre Impact Calculator](/under-the-hood/calculators), which lets users enter their own tonnage, price and cost assumptions across three scenarios — skipped but maintained, removed without replanting and removed and replanted."),
      t("The dollar logic of removal was developed in detail in *[Under the Hood: The Dismal Math of Napa’s Unharvested Acres](https://napavalleyfocus.substack.com/p/under-the-hood-the-dismal-math-of)* (November 2025), which estimated that depending on how many acres are affected, the five-year regional output loss ranges from hundreds of millions to several billion dollars. The current season’s removal pace tracks the upper end of that range."),
      h("More Than One Pathogen"),
      t("Grapes are not the only crop under pressure this spring."),
      t("Buckland has felt the pressure across multiple diseases this year. “Red blotch for sure still the number one problem for us. It’s a bad botrytis year due to the spring rains. Shaping up to be a bad mildew year as well,” he said. “I lost 3 mature pear trees this year to fire blight.” Three other growers at a recent Napa Farmers Guild gathering at Long Meadow Ranch independently described 2026 as “a really bad year” for fire blight. A Master Gardener column in this week’s *[Green Wednesday: Fire Blight in Napa Orchards and Funding for Wildfire Prevention](https://napavalleyfocus.substack.com/p/green-wednesday-fire-blight-in-napa)* (May 27, 2026) documents an unusually severe fire blight outbreak across the valley this spring — Aileen Carroll of the UC Master Gardeners of Napa County reports “dozens” of homeowners arriving at her local nursery with infected apple and pear trees."),
      t("Fire blight is not a grapevine disease. The bacterium responsible, *Erwinia amylovora*, infects pome fruit — apples, pears, quinces — not *Vitis vinifera*. What growers like Buckland are watching is not a direct threat to the vines. It is the pattern. Add Buckland’s pear trees to the GWSS detection at the Costco, the lanternfly egg masses intercepted in Sonoma, the spread of grapevine red blotch and the milder-winter mechanism behind all of them, and a single picture starts to come into focus: opportunistic pathogens are finding more openings across the agricultural matrix, not just in the vineyards."),
      h("The Climate Backdrop"),
      t("The pest pressure visible at the Napa Costco this month does not exist in isolation. It sits on top of a slow shift in the climate conditions that historically held many of these pathogens in check."),
      t("As I covered in *[Under the Hood: Climate Change’s Growing Impact on Napa Valley](https://napavalleyfocus.substack.com/p/under-the-hood-climate-changes-growing)* in August 2024, the warmer-winters story is no longer abstract. California has experienced a 3°F rise in average temperatures since 1896, and warmer winter nights specifically have allowed populations of pests including the glassy-winged sharpshooter to expand. Less frost means fewer overwintering kills. Fewer overwintering kills means more vectors entering each new growing season — and more chances for the diseases those vectors carry, including Pierce’s disease and grapevine red blotch, to spread."),
      t("The pest record runs the same direction. In a *NorthBay Biz* column in [December 2021](https://www.northbaybiz.com/2021/12/02/vineyard-pests-a-game-of-whack-a-mole/), I covered the discovery of five glassy-winged sharpshooters in a Solano County vineyard — a small detection that nonetheless triggered a state rapid-response team because of what GWSS carries. That column closed with the prediction that “pests will continue to find their way to vineyards, with perhaps the next biggest threat being the spotted lanternfly, expected to arrive here in the next few years.” Thirty viable lanternfly egg masses were intercepted in Sonoma County in March 2024. Now GWSS shipments have been documented across at least five Northern California counties, including 220 grapevines into Napa Costco between April 21 and May 26."),
      t("A [March 2023 follow-up piece in *NorthBay Biz*](https://www.northbaybiz.com/2023/03/15/grapevine-pests-and-diseases-are-on-the-uptick/) catalogued the broader picture: more than 70 different viruses now known to affect grapevines, with vectors including the Western grape leafhopper that spreads red blotch and the spotted lanternfly whose excrement can carry the fungus responsible for black rot. The piece concluded that “due to a host of drivers — extreme weather, climate change, novel pest pressures and the risk of rapid monoculture contagions — the threat to vineyard health is expected to increase in the coming years.”"),
      t("The Costco detection is one expression of that broader trend. The vines themselves are remarkably adaptable — they grow in Nova Scotia and Norway — but the disease ecology around them, like the labor pool, the water supply and the contract economics, is not. The question Garrett Buckland and others raise — whether the industry is responding to economic pressure faster than it is responding to biological pressure — is in part a question about which clock is moving faster: the demand curve, or the climate curve."),
      h("The Threat Still Outside the Gate"),
      t("The other pest on growers’ minds in 2026 is one that has not yet established in California: the spotted lanternfly, an invasive planthopper first identified in Pennsylvania in 2014 that has since spread to at least 14 states."),
      t("A 2022 modeling study published in [Communications Biology](https://www.nature.com/articles/s42003-022-03447-0) estimated a low probability that the spotted lanternfly would first reach California’s grape-producing counties by 2027 and a high probability by 2033 without preventative management. The species feeds on grapevines, hops, stone fruit, walnuts and other commercially significant crops, and its preferred host, the tree-of-heaven, is present across Northern California."),
      t("The pest has already turned up at the state’s border. In March 2024, [30 viable spotted lanternfly egg masses were intercepted in Sonoma County](https://www.mastergardenersd.org/the-spotted-lanternfly-is-headed-our-way/) on equipment attempting to enter California — enough viable eggs to seed a founding population."),
      t("Both the Costco GWSS detection and the Sonoma lanternfly interception share a structural feature: both moved through commercial channels — nursery stock in one case, transported equipment in the other — that are difficult to inspect comprehensively in real time."),
      h("The Over-Correction Question"),
      t("Buckland has been making a particular argument about California’s vineyard contraction for at least two years. In *[2024 Harvest Report Reveals a Grape Market Splitting in Two](https://napavalleyfocus.substack.com/p/7-2024-harvest-report-reveals-a-grape)* (December 2025), he described the dynamic this way: “Some of that is natural — older vineyards coming out at the end of their lifespan — but we’re also seeing growers pull vines early because they’re too costly to farm and don’t fit the market. If you’re in an expensive-to-farm area and can’t sell to the high end or compete at the commodity level, there aren’t many off-ramps.”"),
      t("The market context for that argument was developed across several earlier Under the Hood installments — *[Napa County’s Wine Market Is Clearing, Not Recovering](https://napavalleyfocus.substack.com/p/under-the-hood-napa-countys-wine)* (April 2026), *[Wine Supply Outruns Demand](https://napavalleyfocus.substack.com/p/under-the-hood-wine-supply-outruns)* (December 2025), *[Napa Cabernet Prices Break the Growth Curve](/under-the-hood/napa-cab-2025)* (March 2026) and *[How a Global Supply Shock Reaches Napa Valley](/under-the-hood/napa-supply-chain-2026)* (March 2026). The collective picture: the market remains structurally long, with roughly 30% of California winegrapes uncontracted in 2025 and a market that needs to lose meaningful volume before clearing."),
      t("Buckland’s argument is not that the over-correction has arrived. It is that the variables driving removal — economic pressure on growers in expensive-to-farm regions, narrowing buyer universes, climate-driven yield variability and now a new pest vector entering on retail-sold nursery stock — are not all moving in the same direction as the demand-side correction. Removal is moving on a faster clock than replanting. Disease pressure is involuntary and harder to reverse. The two clocks running together change the arithmetic."),
      t("Buckland has long predicted that the industry may be at risk of over-correction. “Lots of vineyards out, and a very light crop this year,” he said, describing the spring’s removal pace. The economic pressure is showing up alongside the disease pressure, and the response — pulling acres faster than the industry has historically pulled them — is creating its own dynamic."),
      h("What to Watch Next"),
      t("The immediate question is whether any of the 157 unaccounted Costco grapevines turn up infested, and how quickly Napa County’s monitoring traps either confirm spread or close out the detection."),
      t("The longer question is the one Buckland has been asking for two years. With another 40,000 acres projected to come out across California in 2026, with this spring’s disease pressure compounding involuntary loss and with a new vector entering through a retail channel the state’s containment system was not built to police, where in the curve are we now? Three years from a real supply problem? Five? Ten? Or do conditions keep moving the goalposts so the over-correction never lands?"),
      t("Every block that comes out of production for economic reasons reduces capacity by choice. Every block that comes out for pest or disease reasons reduces it involuntarily. The arithmetic is the same. The path matters because involuntary removal is harder to reverse."),
      t("Residents who purchased plants at Napa Costco between April 21 and May 26 are asked to call 707-253-4357 or email agcommissioner@countyofnapa.org without planting, transporting, returning or composting the plants."),
      h("What to Do If You Purchased a Plant at Napa Costco in April or May"),
      t("The Napa County Agricultural Commissioner’s office asks that anyone who purchased a grapevine, citrus tree or other fruit tree at Napa Costco — or neighboring Costco locations — during April or May:"),
      t("- Keep the plant isolated in its original pot or container"),
      t("- Do not plant the grapevine or tree if you have not already done so"),
      t("- If possible, place the plant in two secured trash bags, one inside the other, and seal them closed"),
      t("- Do not attempt to return, transport or relocate the plant"),
      t("- Do not place the plant in the trash or a compost bin"),
      t("- Immediately contact the Napa County Agricultural Commissioner’s Office at 707-253-4357 or agcommissioner@countyofnapa.org"),
      t("An agricultural inspector will be dispatched the same day to examine the plant and any nearby host plants."),
      t("Source: [Napa County Agricultural Commissioner](https://www.napacounty.gov/1278/Glassy-winged-Sharpshooter)"),
    ],
    captions: [
      {
        number: 1,
        title: "California Winegrape Acreage by Bearing Status, 2023–2025",
        description: "Total California winegrape acreage fell 11.5% over two years, but the contraction was uneven: bearing acreage declined 5.6% year over year in 2025, while non-bearing acreage — vines planted in the past three years and not yet producing fruit — fell 25%. The collapse in non-bearing acreage is the leading indicator of replant pullback.",
        sources: [{ label: "USDA NASS / CDFA California Grape Acreage Report, April 22, 2026", url: "https://www.edhat.com/california/news/californias-wine-grape-acreage-drops-in-2025-as-industry-struggles-continue-new-report-shows/" }],
      },
      {
        number: 2,
        title: "California Winegrape Removals by County, October 2024 – August 2025",
        ...
        sources: [{ label: "2025 Standing Winegrape Acreage Report, Land IQ for CAWG", url: "https://robbreport.com/food-drink/wine/california-winemakers-removing-acres-vines-1237351654/" }],
      },
    ],
    relatedCoverage: [
      { title: "Climate Change’s Growing Impact on Napa Valley", publication: "Napa Valley Features", date: "August 2024", url: "https://napavalleyfocus.substack.com/p/under-the-hood-climate-changes-growing" },
      ...
      { title: "Under the Hood: Wine Supply Outruns Demand", publication: "Napa Valley Features", date: "December 2025", url: "https://napavalleyfocus.substack.com/p/under-the-hood-wine-supply-outruns" },
      { title: "2024 Harvest Report Reveals a Grape Market Splitting in Two", publication: "Napa Valley Features", date: "December 2025", url: "https://napavalleyfocus.substack.com/p/7-2024-harvest-report-reveals-a-grape" },
      { title: "Under the Hood: Napa County’s Wine Market Is Clearing, Not Recovering", publication: "Napa Valley Features", date: "April 2026", url: "https://napavalleyfocus.substack.com/p/under-the-hood-napa-countys-wine" },
      { title: "Under the Hood: Napa Cabernet Prices Break the Growth Curve", publication: "NapaServe", date: "March 2026", url: "/under-the-hood/napa-cab-2025" },
      { title: "Under the Hood: How a Global Supply Shock Reaches Napa Valley", publication: "NapaServe", date: "March 2026", url: "/under-the-hood/napa-supply-chain-2026" },
    ],
    substackPolls: [
      { question: "How concerned are you that the Costco GWSS detection could lead to local Pierce’s disease spread?", options: ["Very concerned", "Somewhat concerned", "Watching but not alarmed", "Not concerned", "Not sure"] },
      { question: "When does California’s vineyard contraction flip from over-supply to under-supply?", options: ["Within 3 years", "3 to 5 years", "5 to 10 years", "More than 10 years", "Never — demand keeps falling"] },
    ...
    sources: [
      ...
      "[Napa Valley Grapegrowers — Best Practices for Abandoned and Neglected Vineyards](https://www.napagrowers.org/bestpractices/best-practices-for-abandoned-and-neglected-vineyards) (updated June 2025)",
      "[2025 Standing Winegrape Acreage Report — Land IQ for CAWG, via Robb Report](https://robbreport.com/food-drink/wine/california-winemakers-removing-acres-vines-1237351654/)",
      "[USDA NASS / CDFA California Grape Acreage Report, April 22, 2026 — via Edhat](https://www.edhat.com/california/news/californias-wine-grape-acreage-drops-in-2025-as-industry-struggles-continue-new-report-shows/)",
      "[Jeff Bitter / Allied Grape Growers at Unified Wine and Grape Symposium 2026 — via Farm Progress](https://www.farmprogress.com/grapes/california-on-track-to-raze-another-40-000-acres-of-vineyards)",
      "[Napa County 2025 unharvested-acreage estimate — Napa County Times](https://napacountytimes.com/napa-valley-grapes-were-left-on-the-vine-this-harvest-while-acres-of-vineyards-have-been-pulled-over-the-past-year/)",
      "[Spotted lanternfly establishment risk model — Communications Biology (2022)](https://www.nature.com/articles/s42003-022-03447-0)",
  ...
  "napa-schools-2026": {
    ...
    captions: [
      {
        ...
        sources: [{ label: "California Department of Education Census Day Enrollment, April 2026 release", url: "https://www.cde.ca.gov/ds/ad/filesenrcensus.asp" }],
      },
      {
        number: 2,
        title: "Napa County District K-12 Enrollment Change, 2023-24 to 2025-26",
        description: "Two-year absolute change at each of Napa's six districts. NCOE and St. Helena gain; NVUSD holds essentially flat; three small upvalley districts contract. † Small-base district (under 100 students). ‡ Napa COE serves a specialized student population.",
        sources: [{ label: "California Department of Education Census Day Enrollment, district-level data", url: "https://www.cde.ca.gov/ds/ad/filesenrcensus.asp" }],
      },
      {
        number: 3,
        ...
        sources: [{ label: "California Department of Public Health Live Birth Profiles by County", url: "https://data.chhs.ca.gov/dataset/live-birth-profiles-by-county" }],
      },
      {
        number: "3b",
        ...
        sources: [{ label: "California Department of Public Health Live Birth Profiles by County, indexed", url: "https://data.chhs.ca.gov/dataset/live-birth-profiles-by-county" }],
      },
      {
        number: 4,
        title: "Napa County Districts: EL, Non-EL and Total Enrollment Change",
        description: "Two-year change broken into English Learner, Non-EL, and Total. NVUSD shown on its own panel because its scale dominates. St. Helena's +49 total is entirely non-EL; Calistoga's -42 total masks a -115 EL drop offset by +73 non-EL.",
        sources: [{ label: "California Department of Education Census Day Enrollment, district-level EL composition data", url: "https://www.cde.ca.gov/ds/ad/filesenrcensus.asp" }],
      },
      {
        number: 5,
        ...
        sources: [{ label: "California Department of Education Census Day Enrollment, with adjustments described above", url: "https://www.cde.ca.gov/ds/ad/filesenrcensus.asp" }],
      },
      {
        number: 6,
    ...
    relatedCoverage: [
      { title: "Under the Hood: Napa County Shrunk as Calistoga Grew and the Base Faltered", publication: "Napa Valley Features", date: "May 14, 2026", url: "https://napaserve.org/under-the-hood/napa-population-2025" },
      { title: "The Challenges of Napa's Massive Marketing Machine", publication: "Napa Valley Features", date: "May 7, 2026", url: "https://napaserve.org/under-the-hood/napa-marketing-machine-2026" },
      { title: "Napa Valley Adds Rooms While Demand Lags", publication: "Napa Valley Features", date: "April 30, 2026", url: "https://napaserve.org/under-the-hood/napa-lodging-pricing-2026" },
    ],
    substackPolls: [],
    sources: [
      "California Department of Education, [Census Day Enrollment](https://www.cde.ca.gov/ds/ad/filesenrcensus.asp), 2023-24, 2024-25 and 2025-26 releases.",
      "California Department of Public Health, [Live Birth Profiles by County](https://data.chhs.ca.gov/dataset/live-birth-profiles-by-county), final births by month, 1995-2024.",
      "California Department of Education, [English Learner Reclassification Data](https://www.cde.ca.gov/ds/ad/filesreclass.asp) — referenced as not-yet-published past 2020-21.",
      "California Department of Education, [English Language Proficiency Assessments for California (ELPAC)](https://www.cde.ca.gov/ta/tg/ep/) — reference for EL terminology.",
      "California Department of Education, [Private School Affidavit data](https://www.cde.ca.gov/ds/si/ps/), 2019-20 through 2024-25.",
      "California Department of Finance, [E-1 Population Estimates](https://dof.ca.gov/forecasting/demographics/estimates-e1/), May 2026 release.",
      "California Department of Finance, [E-4 Historical Population Estimates](https://dof.ca.gov/forecasting/demographics/estimates/e-4-population-estimates-for-cities-counties-and-the-state-2011-2020-with-2010-and-2020-census-benchmark/).",
      "[Kidsdata.org](https://www.kidsdata.org/), 'Public School Enrollment by Race/Ethnicity, 1994-2021' and 'Public School Enrollment 2012-2021' (compiled from CDE DataQuest).",
    ],
    links: [
      { label: "Read interactive version", url: "https://napaserve.org/under-the-hood/napa-schools-2026" },
    ],
  },
  "napa-population-2025": {
    ...
    body: [
      ...
      t("Napa County sits inside that frame. The county lost 246 residents to land at 136,374, a decline of 0.18%. California fell 0.14%. Both declined for the first time since the COVID rebound, and Napa's decline was modestly steeper than the state's."),
      ...
      t("The [2024 American Community Survey](https://www.census.gov/quickfacts/fact/table/napacountycalifornia/PST045224) quantifies the dynamic the Housing Element draft described in residents’ words. In Napa County, roughly 5.6% of all housing units are classified as vacant for seasonal, recreational or occasional use — more than twice the California rate of 2.4%, and the largest single category of vacant housing in the county. More than half of every vacant unit in Napa County is held as second-home or vacation property. In Calistoga specifically, the for-sale and sold-not-occupied categories show essentially zero units; the vacancy that exists is split between rentals and seasonal use. The Calistoga housing market does not turn over. It holds."),
      t("The numbers behind the argument: Napa County’s NAICS 72 average annual wage — the dominant local industry of accommodation and food services — was [$47,009 in 2024](https://labormarketinfo.edd.ca.gov/geography/napa-county.html), with the lodging subsector at $53,623 and food services at $42,490. Total NAICS 72 employment in the county: 12,026 workers. Calistoga’s median household income, per 2020-2024 ACS 5-year estimates, was $85,446 — but the spread between mean ($143,448) and median tells a structural story: a meaningful upper-income tier pulls the average 68% above the typical household, evidence of the second-home and outside-income overlay on the local wage base. Calistoga’s bimodal labor structure shows up in the occupational breakdown: service occupations earned a median $51,259, sales-and-office $53,204, production-and-transport $55,172 — and management/business/science/arts [$111,250](https://www.census.gov/quickfacts/fact/table/napacountycalifornia/PST045224). More than double the service-occupation median."),
      t("Wage growth, measured against the cost basket of actually living where the work happens, was essentially flat. NAICS 72 average annual wage rose from $31,689 in 2016 to $47,009 in 2024 — a 48.3% nominal gain over eight years. Over the same window, U.S. CPI rose 30.7%. By the standard national deflator the wage-side gain looks modest but real. Measured against the local cost basket — the housing, utility and service prices that govern living in Calistoga — the picture inverts. Calistoga’s median gross rent rose from $1,153 in the 2012-2016 ACS 5-year to $1,767 in the 2020-2024 5-year, a 53.3% increase. Napa County rents rose 55.1% over the same window. The [Zillow Home Value Index](https://www.zillow.com/home-values/3929/calistoga-ca/) for Calistoga peaked above $1.18 million in early 2022 from a 2016 baseline closer to $700,000, a roughly 70% climb. As of May 2026, the typical Calistoga home is valued at $1,079,044, with 34 active listings asking a median of $2,048,833 — a market where what is actually for sale sits well above what is typically owned. Inside Calistoga itself, the Zillow data show the average home value at [$1,062,298 as of March 31, 2026](https://www.zillow.com/home-values/3929/calistoga-ca/), with the 27 active listings asking a median of $1,890,167. Wages did not keep pace with rents nominally — they trailed. The cost of actually living in Calistoga rose faster than the wages of the industry the town’s economy is built on. Workers’ real purchasing power against the cost of living where they work did not keep pace."),
      t("The structural ratios put the mismatch in one number. Calistoga’s home values of $1,079,044 stand at 12.6 times the city’s median household income of $85,446 — about 58% above the Napa County figure of 8.0 times. The county-wide ratio in 2010 was 4.5 times; by 2025, Rethinking the Housing Narrative documented it had reached 8.6 times. Calistoga’s housing-to-income ratio of 12.6 is nearly three times the 2010 county baseline of 4.5. Against the average wage of the dominant local industry — $47,009 — the Calistoga ratio rises to 23.0 times, [roughly five times the 2010 baseline](https://www.zillow.com/home-values/3929/calistoga-ca/)."),
      h("23 times the wages of the industry that staffs the town."),
      t("A tourism worker pulling the local average wage would need 23 years of gross earnings — every dollar, before taxes, before food, before transportation, before anything — to buy a typical home in Calistoga. At a 30% savings rate (which is fantasy for someone earning $47,009), the full home value takes 77 years."),
      t("The 34 active listings asking a median of $2.05 million sit at 44 times the local industry wage. What’s actually for sale right now requires nearly half a century of gross tourism earnings."),
      c(3),
    ...
    captions: [
      ...
      { number: 1.5, title: "North Bay counties ranked by population change", description: "Napa fell 0.2% — less than most of its North Bay neighbors and matched Sonoma, while the South Bay added residents. Of the eleven Bay Area counties shown, only Santa Clara, San Francisco and San Mateo gained population between January 2025 and January 2026; the rest contracted, with Marin and Mendocino losing the most.", source: "California Department of Finance E-1 Population and Housing Estimates, May 1, 2026." },
      ...
      { number: 3, title: "Housing-to-income multipliers in Napa County and Calistoga", description: "The ratio of typical home values to typical household incomes has risen sharply from the 2010 county baseline. Calistoga’s ratio is about 58% above the current Napa County figure; against the wages of the dominant local industry — accommodation and food services — the multiplier is nearly three times the county-wide household ratio.", source: "U.S. Census ACS 5-year estimates 2024; BLS QCEW Napa County 2024; Zillow Home Value Index, Calistoga, May 2026; 2010 baseline per Rethinking the Housing Narrative in Napa County (Napa Valley Features, June 2025)." },
    ...
    sources: [
      ...
      "Zillow Home Value Index, [Calistoga and Napa County, May 2026](https://www.zillow.com/home-values/3929/calistoga-ca/).",
