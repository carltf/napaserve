...
const EXPORT_DATA = {
  "napa-schools-2026": {
    ...
    sources: [
      ...
      "California Department of Finance, [E-4 Historical Population Estimates](https://dof.ca.gov/forecasting/demographics/estimates-e4/).",
