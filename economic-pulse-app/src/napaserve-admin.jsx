...
const EXPORT_DATA = {
  "napa-population-2025": {
    ...
    body: [
      ...
      t("The structural ratios put the mismatch in one number. Calistoga’s home values stand at 12.4 times the city’s median household income — about 55% above the Napa County figure of 8.0 times. Against the average wage of the dominant local industry, the Calistoga ratio rises to 22.6 times. The county-wide ratio in 2010 was 4.5 times; by 2025, Rethinking the Housing Narrative documented it had reached 8.6 times. Calistoga’s housing-to-income ratio of 12.4 is roughly three times the 2010 county baseline of 4.5. Against the wages that the town’s tourism economy actually pays — $47,009 on average — the multiplier rises to 22.6, [roughly five times the 2010 baseline](https://files.zillowstatic.com/research/public_csvs/zhvi/City_zhvi_uc_sfrcondo_tier_0.33_0.67_sm_sa_month.csv)."),
      c(3),
