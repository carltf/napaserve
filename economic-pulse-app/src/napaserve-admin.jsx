...
const EXPORT_DATA = {
  "napa-population-2025": {
    ...
    body: [
      ...
      t("And 23 isn’t the worst of it. The 34 active listings asking a median of $2.05 million sit at 44 times the local industry wage. What’s actually for sale right now requires nearly half a century of gross tourism earnings."),
      c(3),
