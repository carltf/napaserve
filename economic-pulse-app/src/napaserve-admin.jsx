...
const EXPORT_DATA = {
  "napa-farming-2026-gwss": {
    ...
    body: [
      t("NAPA VALLEY, Calif. — The Napa County Agricultural Commissioner’s office issued an urgent alert on May 26 — earlier than the office had planned — warning that grapevines sold at the Napa Costco between April 21 and May 26 may be carrying the glassy-winged sharpshooter, an invasive leafhopper that transmits Pierce’s disease, a bacterial infection that is generally fatal to grapevines."),
      t("The shipments came from Burchell Nursery, Inc., in Fresno County and totaled 220 grapevines. Sixty-three have been destroyed and one GWSS egg mass was confirmed. The remaining 157 plants are unaccounted for and may now be sitting in private yards across the county. Live-stage GWSS detections have also been reported on shipments from the same nursery to Sonoma, Marin, Solano and Yolo counties, according to the county statement."),
      t("“GWSS is a devastating pest for our local vineyards,” Napa County Agricultural Commissioner Tracy Cleveland said in the announcement. “It is critical for us to track down any potentially affected plants purchased at Costco or brought into Napa County.”"),
      t("The county is asking anyone who purchased grapevines, citrus or other fruit trees at Napa Costco or neighboring Costco locations in April or May to isolate the plants in their original containers, leave them unplanted and call 707-253-4357 or email agcommissioner@countyofnapa.org. Background on Pierce’s disease and GWSS is available through the [California Department of Food and Agriculture](https://www.cdfa.ca.gov/pdcp/)."),
      t("[VERIFY: confirm exact county press-release URL once posted on countyofnapa.org and add as inline link on first reference to the announcement.]"),
      ...
      t("[VERIFY: identify the specific recent state law on abandoned/neglected vineyards Buckland referenced — pending Buckland follow-up. Cite by bill number once confirmed.]"),
      ...
      t("“Red blotch for sure still the number one problem for us,” Buckland said when asked what other pressures growers are tracking. “It’s a bad botrytis year due to the spring rains. Shaping up to be a bad mildew year as well. I lost 3 mature pear trees this year to fire blight.”"),
      t("Red blotch is a viral disease that reduces fruit ripening and sugar accumulation in infected vines. Botrytis is a fungal rot that thrives in wet conditions during bloom. Mildew pressure tracks moisture and temperature patterns through spring. Fire blight, a bacterial infection caused by Erwinia amylovora, primarily affects pear and apple trees rather than grapevines. According to [UC IPM](https://ipm.ucanr.edu/agriculture/pear/fire-blight/), fire blight advances quickly in warm, humid conditions and can take down a young orchard inside a single season."),
      t("[VERIFY / SOURCE NEEDED: whether Buckland’s three-tree fire-blight loss reflects a broader 2026 pattern across Napa County pear and apple growers, or remains localized. Pending Buckland follow-up.]"),
      ...
      t("[VERIFY: Buckland on-record framing of the 3-year / 5-year / 10-year / never question — pending follow-up. Replace this paragraph or extend it with his direct quote once received.]"),
